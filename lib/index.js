...
class Api {
    ...
    load(apiPath, projectRoot) {
        this.apiPath = apiPath;
        this.raml = raml1Parser.loadApiSync(apiPath);
        this.projectRoot = projectRoot || path.dirname(require.main.filename);
        cdsHot.init(this.projectRoot, !!process.env.ISHOT);
